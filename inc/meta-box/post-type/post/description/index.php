...
function buildpro_post_desc_render_meta_box($post)
{
    ...
    echo '<p class="buildpro-post-field"><label>' . esc_html__('Description', 'buildpro') . '</label><textarea name="buildpro_post_description" rows="5" class="large-text">' . esc_textarea($post_desc) . '</textarea></p>';
    echo '</div>';
}
