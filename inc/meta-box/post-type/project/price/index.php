<?php
function buildpro_project_price_add_meta_box($post_type, $post)
{
...
function buildpro_project_price_render_meta_box($post)
{
    $price = get_post_meta($post->ID, 'price_project', true);
    echo '<style>
