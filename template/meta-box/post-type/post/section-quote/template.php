<div class="buildpro-post-block">
    ...
    <p class="buildpro-post-field">
        <label><?php esc_html_e('Image Description', 'buildpro'); ?></label>
    ...
    <div class="buildpro-post-field">
        <label><?php esc_html_e('Gallery', 'buildpro'); ?></label>
        ...
        <button type="button" class="button" id="buildpro_post_add_gallery"><?php esc_html_e('Add image', 'buildpro'); ?></button>
    </div>
    <div class="buildpro-post-field">
        <label><?php esc_html_e('Quote Repeater', 'buildpro'); ?></label>
        <div id="buildpro_post_quote_kv">
            ...
            foreach ($quote_kv as $row) : ?>
                ...
                <div class="kv-row" data-index="<?php echo esc_attr($i); ?>">
                    <input type="text" name="buildpro_post_quote_kv[<?php echo esc_attr($i); ?>][key]" value="<?php echo esc_attr($k); ?>" placeholder="<?php esc_attr_e('Key', 'buildpro'); ?>" class="regular-text">
                    <input type="text" name="buildpro_post_quote_kv[<?php echo esc_attr($i); ?>][value]" value="<?php echo esc_attr($v); ?>" placeholder="<?php esc_attr_e('Value', 'buildpro'); ?>" class="regular-text">
                    <button type="button" class="button remove-kv"><?php esc_html_e('Remove', 'buildpro'); ?></button>
                </div>
            <?php $i++;
            endforeach; ?>
        </div>
        <button type="button" class="button button-primary" id="buildpro_post_add_kv"><?php esc_html_e('Add row', 'buildpro'); ?></button>
    </div>
</div>