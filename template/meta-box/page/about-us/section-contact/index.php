...
<div id="buildpro_about_contact_meta">
    <div class="buildpro-admin-tabs">
        <button type="button" class="button buildpro-about-contact-tabs is-active"
            data-tab="buildpro_about_contact_tab_content"><?php echo esc_html__('Content', 'buildpro'); ?></button>
        <button type="button" class="button buildpro-about-contact-tabs"
            data-tab="buildpro_about_contact_tab_contact"><?php echo esc_html__('Contact', 'buildpro'); ?></button>
    </div>
    <div id="buildpro_about_contact_tab_content">
        ...
        <p><label><?php echo esc_html__('Title', 'buildpro'); ?><br><input type="text" class="widefat" name="buildpro_about_contact_title"
                    value="<?php echo esc_attr($title); ?>"></label></p>
        <p><label><?php echo esc_html__('Text', 'buildpro'); ?><br><input type="text" class="widefat" name="buildpro_about_contact_text"
        ...
        <div class="buildpro-field buildpro-field--image">
            ...
            ?>
            <label><?php echo esc_html__('Map Image', 'buildpro'); ?></label>
            ...
            <p>
                <button type="button" class="button buildpro-map-upload"><?php echo esc_html__('Choose Image', 'buildpro'); ?></button>
                <button type="button" class="button buildpro-map-remove"><?php echo esc_html__('Remove', 'buildpro'); ?></button>
            </p>
        </div>
    </div>
    <div id="buildpro_about_contact_tab_contact" style="display: none;">
        <p><label><?php echo esc_html__('Address', 'buildpro'); ?><br><input type="text" class="widefat" name="buildpro_about_contact_address"
                    value="<?php echo esc_attr($address); ?>"></label></p>
        <p><label><?php echo esc_html__('Phone', 'buildpro'); ?><br><input type="text" class="widefat" name="buildpro_about_contact_phone"
                    value="<?php echo esc_attr($phone); ?>"></label></p>
        <p><label><?php echo esc_html__('Email', 'buildpro'); ?><br><input type="text" class="widefat" name="buildpro_about_contact_email"
