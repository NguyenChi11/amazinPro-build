...
<section class="checkout-section">
    <div class="container">
        ...
        <div class="checkout-section__header">
            <h1 class="checkout-section__title">Checkout</h1>
            <p class="checkout-section__subtitle">Complete your details to place the order.</p>
        </div>
        ...
        <div class="checkout-section__wrapper">
            ...
            <div class="checkout-section__left">
                ...
                <div class="checkout-card">
                    <h2 class="checkout-card__title">Shipping Information</h2>
                    <form class="checkout-form" id="checkout-form" novalidate>

                        <div class="checkout-form__row">
                            <div class="checkout-form__group">
                                <label class="checkout-form__label" for="co-fullname">Full Name <span>*</span></label>
                            ...
                            <div class="checkout-form__group">
                                <label class="checkout-form__label" for="co-phone">Phone Number <span>*</span></label>
                        ...
                        <div class="checkout-form__group">
                            <label class="checkout-form__label" for="co-email">Email Address <span>*</span></label>
                        ...
                        <div class="checkout-form__group">
                            <label class="checkout-form__label" for="co-address">Address <span>*</span></label>
                        ...
                        <div class="checkout-form__row">
                            <div class="checkout-form__group">
                                <label class="checkout-form__label" for="co-city">City <span>*</span></label>
                            ...
                            <div class="checkout-form__group">
                                <label class="checkout-form__label" for="co-zip">ZIP / Postal Code</label>
                        ...
                        <div class="checkout-form__group">
                            <label class="checkout-form__label" for="co-country">Country <span>*</span></label>
                        ...
                        <div class="checkout-form__group">
                            <label class="checkout-form__label" for="co-note">Order Notes</label>
                ...
                <div class="checkout-card checkout-card--payment">
                    ...
                    <div class="payment-tabs payment-tabs--count-<?php echo esc_attr($payment_tab_count); ?>"
                        ...
                        <button class="payment-tab payment-tab--active" role="tab" data-target="tab-cod"
                            ...
                            <span class="payment-tab__label">Cash on<br>Delivery</span>
                        </button>
                        ...
                        <button class="payment-tab" role="tab" data-target="tab-card" aria-selected="false">
                            ...
                            <span class="payment-tab__label">Credit<br>Card</span>
                        </button>
                        ...
                        <button class="payment-tab" role="tab" data-target="tab-bank" aria-selected="false">
                            ...
                            <span class="payment-tab__label">Bank Transfer</span>
                        </button>
                    ...
                    <div class="payment-panels">
                        ...
                        <div class="payment-panel payment-panel--active" id="tab-cod" role="tabpanel">
                            ...
                            <p class="payment-panel__desc">
                                Pay in cash upon delivery. Our delivery staff will collect payment directly at your
                                shipping address.
                            </p>
                            <div class="payment-panel__note">
                                ...
                                Please prepare the exact amount to make the delivery process smoother.
                            </div>
                        </div>
                        ...
                        <div class="payment-panel" id="tab-paypal" role="tabpanel">
                            ...
                            <button type="button" id="bp-paypal-pay-btn" class="payment-panel__paypal-btn">
                                ...
                                <?php echo esc_html(sprintf(__('Continue with %s', 'build-pro-v2'), $paypal_title)); ?>
                            </button>
                            <div class="payment-panel__note">
                                <svg viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd"
                                ...
                                You will be redirected to PayPal and returned here after authorization.
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="payment-panel" id="tab-card" role="tabpanel">
                            ...
                            <div class="checkout-form__group">
                                <label class="checkout-form__label" for="card-number">Card Number <span>*</span></label>
                            ...
                            <div class="checkout-form__row">
                                <div class="checkout-form__group">
                                    <label class="checkout-form__label" for="card-expiry">Expiry Date
                                        <span>*</span></label>
                                ...
                                <div class="checkout-form__group">
                                    <label class="checkout-form__label" for="card-cvc">CVV Code <span>*</span></label>
                                    <input class="checkout-form__input" type="text" id="card-cvc" name="card_cvc"
                                        placeholder="123" maxlength="4" autocomplete="cc-csc">
                                </div>
                            </div>
                            <div class="checkout-form__group">
                                <label class="checkout-form__label" for="card-name">Name on Card <span>*</span></label>
                            ...
                            <div class="payment-panel__secure">
                                ...
                                Card details are encrypted with 256-bit SSL
                            </div>
                        </div>
                        ...
                        <div class="payment-panel" id="tab-bank" role="tabpanel">
                            ...
                            <div class="bank-info<?php echo $i > 0 ? ' bank-info--extra' : ''; ?>">
                                ...
                                <div class="bank-info__row">
                                    <span class="bank-info__label">Bank</span>
                                    <span class="bank-info__value"><?php echo esc_html($bank_name); ?></span>
                                </div>
                                <?php endif; ?>
                                <?php if ($acct_name) : ?>
                                <div class="bank-info__row">
                                    <span class="bank-info__label">Account Name</span>
                                    <span class="bank-info__value"><?php echo esc_html($acct_name); ?></span>
                                </div>
                                <?php endif; ?>
                                <?php if ($acct_number) : ?>
                                <div class="bank-info__row">
                                    <span class="bank-info__label">Account No.</span>
                                ...
                                <?php if ($iban) : ?>
                                <div class="bank-info__row">
                                    <span class="bank-info__label">IBAN</span>
                                    <span class="bank-info__value bank-info__value--copy"
                                        id="<?php echo esc_attr($copy_id . '-iban'); ?>"><?php echo esc_html($iban); ?></span>
                                    <button class="bank-info__copy-btn"
                                        data-copy="<?php echo esc_attr($copy_id . '-iban'); ?>" title="Copy">
                                        <svg viewBox="0 0 20 20" fill="currentColor">
                                            <path d="M8 3a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1z" />
                                            <path
                                                d="M6 3a2 2 0 00-2 2v11a2 2 0 002 2h8a2 2 0 002-2V5a2 2 0 00-2-2 3 3 0 01-3 3H9a3 3 0 01-3-3z" />
                                ...
                                <?php if ($bic) : ?>
                                <div class="bank-info__row">
                                    <span class="bank-info__label">BIC / Swift</span>
                                    <span class="bank-info__value bank-info__value--copy"
                                        id="<?php echo esc_attr($copy_id . '-bic'); ?>"><?php echo esc_html($bic); ?></span>
                                    <button class="bank-info__copy-btn"
                                        data-copy="<?php echo esc_attr($copy_id . '-bic'); ?>" title="Copy">
                                        <svg viewBox="0 0 20 20" fill="currentColor">
                                            <path d="M8 3a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1z" />
                                            <path
                                                d="M6 3a2 2 0 00-2 2v11a2 2 0 002 2h8a2 2 0 002-2V5a2 2 0 00-2-2 3 3 0 01-3 3H9a3 3 0 01-3-3z" />
                            ...
                            <div class="payment-panel__note">
                                ...
                                No bank account details have been configured yet. Please contact us for payment
                                instructions.
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="payment-panel__note">
                                ...
                                Please use the exact reference code so your order can be processed quickly.
                            </div>
                        </div>
            ...
            <div class="checkout-section__right">
                <div class="checkout-card checkout-card--summary">
                    <h2 class="checkout-card__title">Order Summary</h2>

                    <div class="order-items" id="order-items">
                        <?php if (empty($cart_items)) : ?>
                        <p class="order-items__empty">Your cart is empty.</p>
                        <?php else : ?>
                        ...
                        <div class="order-item">
                            ...
                            <div class="order-item__info">
                                ...
                                <p class="order-item__meta">Qty: <?php echo esc_html($qty); ?></p>
                            ...
                            <p class="order-item__total"><?php echo $bp_price($sale_item_total); ?></p>
                        </div>
                        <?php endforeach; ?>
                        <?php endif; ?>
                    </div>
