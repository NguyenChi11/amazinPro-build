...
<section class="checkout-section">
    <div class="container">
        ...
        <div class="checkout-section__header">
            ...
            <p class="checkout-section__subtitle"><?php esc_html_e('Complete your details to place the order.', 'buildpro'); ?></p>
        </div>
                    ...
                    <form class="checkout-form" id="checkout-form" novalidate>
                        ...
                        <div class="checkout-form__row">
                            <div class="checkout-form__group">
                                <label class="checkout-form__label" for="co-fullname"><?php esc_html_e('Full Name', 'buildpro'); ?> <span>*</span></label>
                            ...
                            <div class="checkout-form__group">
                                <label class="checkout-form__label" for="co-phone"><?php esc_html_e('Phone Number', 'buildpro'); ?> <span>*</span></label>
                        ...
                        <div class="checkout-form__group">
                            <label class="checkout-form__label" for="co-email"><?php esc_html_e('Email Address', 'buildpro'); ?> <span>*</span></label>
                        ...
                        <div class="checkout-form__group">
                            <label class="checkout-form__label" for="co-address"><?php esc_html_e('Address', 'buildpro'); ?> <span>*</span></label>
                        ...
                        <div class="checkout-form__row">
                            <div class="checkout-form__group">
                                <label class="checkout-form__label" for="co-city"><?php esc_html_e('City', 'buildpro'); ?> <span>*</span></label>
                            ...
                            <div class="checkout-form__group">
                                <label class="checkout-form__label" for="co-zip"><?php esc_html_e('ZIP / Postal Code', 'buildpro'); ?></label>
                        ...
                        <div class="checkout-form__group">
                            <label class="checkout-form__label" for="co-country"><?php esc_html_e('Country', 'buildpro'); ?> <span>*</span></label>
                        ...
                        <div class="checkout-form__group">
                            <label class="checkout-form__label" for="co-note"><?php esc_html_e('Order Notes', 'buildpro'); ?></label>
                ...
                <div class="checkout-card checkout-card--payment">
                    ...
                    <div class="payment-panels">
                        ...
                        <div class="payment-panel" id="tab-card" role="tabpanel">
                            ...
                            <div class="checkout-form__group">
                                <label class="checkout-form__label" for="card-number"><?php esc_html_e('Card Number', 'buildpro'); ?> <span>*</span></label>
                            ...
                            <div class="checkout-form__row">
                                <div class="checkout-form__group">
                                    <label class="checkout-form__label" for="card-expiry"><?php esc_html_e('Expiry Date', 'buildpro'); ?>
                                        <span>*</span></label>
                                ...
                                <div class="checkout-form__group">
                                    <label class="checkout-form__label" for="card-cvc"><?php esc_html_e('CVV Code', 'buildpro'); ?> <span>*</span></label>
                                    <input class="checkout-form__input" type="text" id="card-cvc" name="card_cvc"
                                        placeholder="123" maxlength="4" autocomplete="cc-csc">
                                </div>
                            </div>
                            <div class="checkout-form__group">
                                <label class="checkout-form__label" for="card-name"><?php esc_html_e('Name on Card', 'buildpro'); ?> <span>*</span></label>
                            ...
                            <?php if (!empty($bacs_accounts)) : ?>
                                ...
                                ?>
                                    <div class="bank-info<?php echo $i > 0 ? ' bank-info--extra' : ''; ?>">
                                        ...
                                        <?php if ($acct_name) : ?>
                                            <div class="bank-info__row">
                                                <span class="bank-info__label"><?php esc_html_e('Account Name', 'buildpro'); ?></span>
                                                <span class="bank-info__value"><?php echo esc_html($acct_name); ?></span>
                                            </div>
                                        <?php endif; ?>
                                        <?php if ($acct_number) : ?>
                                            <div class="bank-info__row">
                                                <span class="bank-info__label"><?php esc_html_e('Account No.', 'buildpro'); ?></span>
                                        ...
                                        <?php if ($sort_code) : ?>
                                            <div class="bank-info__row">
                                                ...
                                                <button class="bank-info__copy-btn"
                                                    data-copy="<?php echo esc_attr($copy_id . '-sort'); ?>" title="<?php esc_attr_e('Copy', 'buildpro'); ?>">
                                                    <svg viewBox="0 0 20 20" fill="currentColor">
                                                        <path d="M8 3a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1z" />
                                                        <path
                                                            d="M6 3a2 2 0 00-2 2v11a2 2 0 002 2h8a2 2 0 002-2V5a2 2 0 00-2-2 3 3 0 01-3 3H9a3 3 0 01-3-3z" />
                                        ...
                                        <?php if ($iban) : ?>
                                            <div class="bank-info__row">
                                                ...
                                                <button class="bank-info__copy-btn"
                                                    data-copy="<?php echo esc_attr($copy_id . '-iban'); ?>" title="<?php esc_attr_e('Copy', 'buildpro'); ?>">
                                                    <svg viewBox="0 0 20 20" fill="currentColor">
                                                        <path d="M8 3a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1z" />
                                                        <path
                                                            d="M6 3a2 2 0 00-2 2v11a2 2 0 002 2h8a2 2 0 002-2V5a2 2 0 00-2-2 3 3 0 01-3 3H9a3 3 0 01-3-3z" />
                                        ...
                                        <?php if ($bic) : ?>
                                            <div class="bank-info__row">
                                                <span class="bank-info__label"><?php esc_html_e('BIC / Swift', 'buildpro'); ?></span>
                                                <span class="bank-info__value bank-info__value--copy"
                                                    id="<?php echo esc_attr($copy_id . '-bic'); ?>"><?php echo esc_html($bic); ?></span>
                                                <button class="bank-info__copy-btn"
                                                    data-copy="<?php echo esc_attr($copy_id . '-bic'); ?>" title="<?php esc_attr_e('Copy', 'buildpro'); ?>">
                                                    <svg viewBox="0 0 20 20" fill="currentColor">
                                                        <path d="M8 3a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1z" />
                                                        <path
                                                            d="M6 3a2 2 0 00-2 2v11a2 2 0 002 2h8a2 2 0 002-2V5a2 2 0 00-2-2 3 3 0 01-3 3H9a3 3 0 01-3-3z" />
                            ...
                            ?>
                                <div class="order-item">
                                    ...
                                    <div class="order-item__info">
                                        ...
                                        <p class="order-item__meta"><?php printf(esc_html__('Qty: %s', 'buildpro'), esc_html($qty)); ?></p>
