...
if (empty($rows)) {
    $rows = get_theme_mod('buildpro_banner_items', array());
}
...
if (empty($option_rows)) {
    $option_rows = get_theme_mod('buildpro_option_items', array());
}
                ...
                <div class="section-banner__item <?php echo $index === 0 ? 'active' : ''; ?> ">
                    <div class="section-banner__item-content">
                        ...
                        <p class="section-banner__item-description">
                            <?php echo esc_html($section_banner_house['description']); ?>
                        </p>
                    </div>
                    <?php
                    ...
                    ?>
                    <?php if ($btn_url): ?>
                        <a class="section-banner__item-button" href="<?php echo esc_url($btn_url); ?>" <?php echo $target_attr . $rel_attr; ?>>
                            <?php echo esc_html($btn_title); ?>
                            <img class="section-banner__item-button-icon"
                                src="<?php echo esc_url(get_theme_file_uri('/assets/images/icon/Vector.png')); ?>"
                        ...
                        <div class="swiper-slide section-banner__options-swiper-item">
                            <div class="section-banner__options-item">
                                ...
                                <h3 class="section-banner__options-item-text">
                                    <?php echo esc_html($section_option_item['text']); ?>
                                </h3>
