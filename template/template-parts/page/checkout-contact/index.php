                    ...
                    <form id="checkout-contact-form" class="checkout-contact__form" action="" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="full_name" name="full_name" required placeholder="<?php _e('Enter your full name', 'buildpro'); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="email" id="email" name="email" required placeholder="<?php _e('Enter your email', 'buildpro'); ?>">
                            </div>
                            <div class="form-group">
                                <label for="phone"><?php _e('Phone Number', 'buildpro'); ?> *</label>
                                <input type="tel" id="phone" name="phone" required placeholder="<?php _e('Enter your phone number', 'buildpro'); ?>">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="message"><?php _e('Additional Notes (Optional)', 'buildpro'); ?></label>
                            <textarea id="message" name="message" rows="4" placeholder="<?php _e('Anything else we should know?', 'buildpro'); ?>"></textarea>
                        </div>

                        <div class="checkout-contact__footer">
                            <button type="submit" class="checkout-contact__submit">
                                <span><?php _e('Confirm Booking', 'buildpro'); ?></span>
                ...
                <?php else: ?>
                    <div class="checkout-contact__promo">
                        <div class="checkout-contact__promo-image">
                            <img src="<?php echo esc_url(get_theme_file_uri('/assets/images/image_contact.jpg')); ?>" alt="">
                        </div>
                        <div class="checkout-contact__promo-text">
                            <h3><?php _e('Why Choose Us?', 'buildpro'); ?></h3>
                            <p><?php _e('We provide world-class construction and architecture services tailored to your vision.', 'buildpro'); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
