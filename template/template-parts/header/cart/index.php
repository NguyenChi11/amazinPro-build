...
<div class="hcd__header">
    <span class="hcd__title"><?php esc_html_e('Your Cart', 'buildpro'); ?></span>
</div>
...
<?php else : ?>
    <ul class="hcd__list">
        <?php foreach ($cart_items as $cart_key => $item) :
            ...
            if (!$unit_label) $unit_label = esc_html__('ton', 'buildpro');
                ...
                <div class="hcd__item-body">
                    <div class="hcd__item-top">
                        ...
                        <button type="button" class="hcd__item-delete" data-cart-key="<?php echo esc_attr($cart_key); ?>"
                            data-remove-url="<?php echo esc_attr(wc_get_cart_remove_url($cart_key)); ?>"
                            aria-label="<?php esc_attr_e('Remove', 'buildpro'); ?>">
                    ...
                    <?php if (!empty($unit)) : ?>
                        <span class="hcd__item-unit"><?php printf(esc_html__('Unit: %s', 'buildpro'), esc_html($unit)); ?></span>
                    <?php endif; ?>
    ...
    <div class="hcd__total">
        <span class="hcd__total-label"><?php esc_html_e('Order total', 'buildpro'); ?></span>
    ...
    <div class="hcd__footer">
        <a href="<?php echo esc_url($cart_url); ?>" class="hcd__view-btn">
            ...
            <?php esc_html_e('View Cart', 'buildpro'); ?>
        </a>
    </div>
<?php endif; ?>