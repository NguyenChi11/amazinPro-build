(function () {
  function init() {
    var hidden = document.getElementById("buildpro-projects-title-data");
    var wrapper = document.getElementById("buildpro-projects-title-wrapper");
    var applyBtn = document.getElementById("buildpro-projects-title-apply");
  ...
  var obs = new MutationObserver(function () {
    if (document.getElementById("buildpro-projects-title-wrapper")) {
      init();
      obs.disconnect();
    }
  });
