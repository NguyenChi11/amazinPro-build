    ...
    ?>
        <div class="buildpro-option-row" data-index="<?php echo esc_attr($index); ?>">
            <div class="buildpro-option-header">
                <span class="buildpro-option-label"><?php echo $text ? esc_html($text) : sprintf(esc_html__('Item %d', 'buildpro'), $index + 1); ?></span>
                <span class="buildpro-option-arrow">&#9660;</span>
            </div>
            <div class="buildpro-option-body" style="display:none">
                <div class="buildpro-option-tabs">
                    <button type="button" class="buildpro-option-tab active" data-tab="icon"><?php echo esc_html__('Icon', 'buildpro'); ?></button>
                    <button type="button" class="buildpro-option-tab" data-tab="content"><?php echo esc_html__('Content', 'buildpro'); ?></button>
                </div>
                <div class="buildpro-option-grid">
                    <div class="buildpro-option-block tab-content" data-tab="icon" style="display:block">
                        ...
                        <div class="buildpro-option-field">
                            ...
                            <button type="button" class="button select-option-icon"><?php echo esc_html__('Select icon', 'buildpro'); ?></button>
                            <button type="button" class="button remove-option-icon"><?php echo esc_html__('Remove icon', 'buildpro'); ?></button>
                        </div>
                ...
                <div class="buildpro-option-actions">
                    <button type="button" class="button remove-option-row"><?php echo esc_html__('Remove item', 'buildpro'); ?></button>
                </div>
...
<button type="button" class="button button-primary" id="buildpro-option-add"><?php echo esc_html__('Add Item', 'buildpro'); ?></button>