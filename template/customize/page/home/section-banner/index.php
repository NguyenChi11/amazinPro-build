...
<div id="buildpro-banner-wrapper">
    ...
    ?>
        <div class="buildpro-banner-row" data-index="<?php echo esc_attr($index); ?>">
            <div class="buildpro-banner-header">
                <span class="buildpro-banner-label"><?php echo $text ? esc_html($text) : sprintf(esc_html__('Item %d', 'buildpro'), $index + 1); ?></span>
            ...
            <div class="buildpro-banner-body" style="display:none">
                <div class="buildpro-banner-grid">
                    ...
                    <div class="buildpro-banner-block">
                        ...
                        <p class="buildpro-banner-field"><label><?php echo esc_html__('Type', 'buildpro'); ?></label><input type="text" class="regular-text"
                                data-field="type" value="<?php echo esc_attr($type); ?>"></p>
                        <p class="buildpro-banner-field"><label><?php echo esc_html__('Text', 'buildpro'); ?></label><input type="text" class="regular-text"
                                data-field="text" value="<?php echo esc_attr($text); ?>"></p>
                        <p class="buildpro-banner-field"><label><?php echo esc_html__('Description', 'buildpro'); ?></label><textarea rows="4" class="large-text"
                        ...
                        <p class="buildpro-banner-field">
                            ...
                            <input type="text" class="regular-text" data-field="link_title"
                                value="<?php echo esc_attr($link_title); ?>" placeholder="<?php echo esc_attr__('Button text', 'buildpro'); ?>">
                        </p>
                        <p class="buildpro-banner-field"><label><?php echo esc_html__('Link Target', 'buildpro'); ?></label><select data-field="link_target">
                                <option value="" <?php selected($link_target, '', true); ?>><?php echo esc_html__('Same Tab', 'buildpro'); ?></option>
                                <option value="_blank" <?php selected($link_target, '_blank', true); ?>><?php echo esc_html__('Open in new tab', 'buildpro'); ?>
                                </option>
                            </select></p>
                        <div class="buildpro-link-panel">
                            <div class="buildpro-banner-block">
                                <h4><?php echo esc_html__('Choose Link', 'buildpro'); ?></h4>
                                <p class="buildpro-banner-field"><label><?php echo esc_html__('Search pages/posts', 'buildpro'); ?></label><input type="text"
                                        class="regular-text buildpro-link-search" placeholder="<?php echo esc_attr__('Enter keyword...', 'buildpro'); ?>"></p>
                                ...
                                <div class="buildpro-banner-actions"><button type="button"
                                        class="button buildpro-link-close"><?php echo esc_html__('Close', 'buildpro'); ?></button></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="buildpro-banner-actions"><button type="button" class="button remove-banner-row"><?php echo esc_html__('Remove item', 'buildpro'); ?></button>
                </div>
    ...
    ?>
</div><button type="button" class="button button-primary" id="buildpro-banner-add"><?php echo esc_html__('Add Item', 'buildpro'); ?></button>
        ...
        <div class="buildpro-banner-body" style="display:block">
            <div class="buildpro-banner-grid">
                ...
                <div class="buildpro-banner-block">
                    ...
                    <h4><?php echo esc_html__('Link', 'buildpro'); ?></h4>
                    <p class="buildpro-banner-field"><label><?php echo esc_html__('Link URL', 'buildpro'); ?></label><input type="url" class="regular-text"
                    ...
                    <p class="buildpro-banner-field"><label><?php echo esc_html__('Link Title', 'buildpro'); ?></label><input type="text" class="regular-text"
                            data-field="link_title" value="" placeholder="<?php echo esc_attr__('Button text', 'buildpro'); ?>"></p>
                    <p class="buildpro-banner-field"><label><?php echo esc_html__('Link Target', 'buildpro'); ?></label><select data-field="link_target">
            ...
            <div class="buildpro-banner-actions"><button type="button" class="button remove-banner-row"><?php echo esc_html__('Remove item', 'buildpro'); ?></button></div>
        </div>
    </div>
</template>