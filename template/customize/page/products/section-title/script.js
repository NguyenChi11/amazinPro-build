(function () {
  function init() {
    var hidden = document.getElementById("buildpro-products-title-data");
    var wrapper = document.getElementById("buildpro-products-title-wrapper");
    var applyBtn = document.getElementById("buildpro-products-title-apply");
  ...
  var obs = new MutationObserver(function () {
    if (document.getElementById("buildpro-products-title-wrapper")) {
      init();
      obs.disconnect();
    }
  });
